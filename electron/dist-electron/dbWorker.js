...
__publicField(ForeignKeyBuilder, _W, "SQLiteForeignKeyBuilder");
_X = entityKind;
class ForeignKey {
...
__publicField(ForeignKey, _X, "SQLiteForeignKey");
function uniqueKeyName(table, columns) {
  return `${table[TableName]}_${columns.join("_")}_unique`;
}
class SQLiteColumnBuilder extends (_Z = ColumnBuilder, _Y = entityKind, _Z) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteColumnBuilder, _Y, "SQLiteColumnBuilder");
class SQLiteColumn extends (_$ = Column, __ = entityKind, _$) {
  constructor(table, config) {
...
__publicField(SQLiteColumn, __, "SQLiteColumn");
class SQLiteBigIntBuilder extends (_ba = SQLiteColumnBuilder, _aa = entityKind, _ba) {
  constructor(name) {
...
__publicField(SQLiteBigIntBuilder, _aa, "SQLiteBigIntBuilder");
class SQLiteBigInt extends (_da = SQLiteColumn, _ca = entityKind, _da) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteBigInt, _ca, "SQLiteBigInt");
class SQLiteBlobJsonBuilder extends (_fa = SQLiteColumnBuilder, _ea = entityKind, _fa) {
  constructor(name) {
...
__publicField(SQLiteBlobJsonBuilder, _ea, "SQLiteBlobJsonBuilder");
class SQLiteBlobJson extends (_ha = SQLiteColumn, _ga = entityKind, _ha) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteBlobJson, _ga, "SQLiteBlobJson");
class SQLiteBlobBufferBuilder extends (_ja = SQLiteColumnBuilder, _ia = entityKind, _ja) {
  constructor(name) {
...
__publicField(SQLiteBlobBufferBuilder, _ia, "SQLiteBlobBufferBuilder");
class SQLiteBlobBuffer extends (_la = SQLiteColumn, _ka = entityKind, _la) {
  getSQLType() {
    return "blob";
  }
}
__publicField(SQLiteBlobBuffer, _ka, "SQLiteBlobBuffer");
function blob(a, b) {
...
class SQLiteCustomColumnBuilder extends (_na = SQLiteColumnBuilder, _ma = entityKind, _na) {
...
__publicField(SQLiteCustomColumnBuilder, _ma, "SQLiteCustomColumnBuilder");
class SQLiteCustomColumn extends (_pa = SQLiteColumn, _oa = entityKind, _pa) {
  constructor(table, config) {
    super(table, config);
...
__publicField(SQLiteCustomColumn, _oa, "SQLiteCustomColumn");
...
class SQLiteBaseIntegerBuilder extends (_ra = SQLiteColumnBuilder, _qa = entityKind, _ra) {
  constructor(name, dataType, columnType) {
...
__publicField(SQLiteBaseIntegerBuilder, _qa, "SQLiteBaseIntegerBuilder");
class SQLiteBaseInteger extends (_ta = SQLiteColumn, _sa = entityKind, _ta) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteBaseInteger, _sa, "SQLiteBaseInteger");
class SQLiteIntegerBuilder extends (_va = SQLiteBaseIntegerBuilder, _ua = entityKind, _va) {
  constructor(name) {
...
__publicField(SQLiteIntegerBuilder, _ua, "SQLiteIntegerBuilder");
class SQLiteInteger extends (_xa = SQLiteBaseInteger, _wa = entityKind, _xa) {
}
__publicField(SQLiteInteger, _wa, "SQLiteInteger");
class SQLiteTimestampBuilder extends (_za = SQLiteBaseIntegerBuilder, _ya = entityKind, _za) {
...
__publicField(SQLiteTimestampBuilder, _ya, "SQLiteTimestampBuilder");
class SQLiteTimestamp extends (_Ba = SQLiteBaseInteger, _Aa = entityKind, _Ba) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteTimestamp, _Aa, "SQLiteTimestamp");
class SQLiteBooleanBuilder extends (_Da = SQLiteBaseIntegerBuilder, _Ca = entityKind, _Da) {
  constructor(name, mode) {
...
__publicField(SQLiteBooleanBuilder, _Ca, "SQLiteBooleanBuilder");
class SQLiteBoolean extends (_Fa = SQLiteBaseInteger, _Ea = entityKind, _Fa) {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", this.config.mode);
  }
...
__publicField(SQLiteBoolean, _Ea, "SQLiteBoolean");
...
class SQLiteNumericBuilder extends (_Ha = SQLiteColumnBuilder, _Ga = entityKind, _Ha) {
  constructor(name) {
...
__publicField(SQLiteNumericBuilder, _Ga, "SQLiteNumericBuilder");
class SQLiteNumeric extends (_Ja = SQLiteColumn, _Ia = entityKind, _Ja) {
  getSQLType() {
    return "numeric";
  }
}
__publicField(SQLiteNumeric, _Ia, "SQLiteNumeric");
function numeric(name) {
  return new SQLiteNumericBuilder(name ?? "");
}
class SQLiteRealBuilder extends (_La = SQLiteColumnBuilder, _Ka = entityKind, _La) {
  constructor(name) {
...
__publicField(SQLiteRealBuilder, _Ka, "SQLiteRealBuilder");
class SQLiteReal extends (_Na = SQLiteColumn, _Ma = entityKind, _Na) {
  getSQLType() {
    return "real";
  }
}
__publicField(SQLiteReal, _Ma, "SQLiteReal");
function real(name) {
  return new SQLiteRealBuilder(name ?? "");
}
class SQLiteTextBuilder extends (_Pa = SQLiteColumnBuilder, _Oa = entityKind, _Pa) {
...
__publicField(SQLiteTextBuilder, _Oa, "SQLiteTextBuilder");
class SQLiteText extends (_Ra = SQLiteColumn, _Qa = entityKind, _Ra) {
  constructor(table, config) {
    super(table, config);
...
__publicField(SQLiteText, _Qa, "SQLiteText");
class SQLiteTextJsonBuilder extends (_Ta = SQLiteColumnBuilder, _Sa = entityKind, _Ta) {
  constructor(name) {
...
__publicField(SQLiteTextJsonBuilder, _Sa, "SQLiteTextJsonBuilder");
class SQLiteTextJson extends (_Va = SQLiteColumn, _Ua = entityKind, _Va) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteTextJson, _Ua, "SQLiteTextJson");
function text(a, b = {}) {
  const { name, config } = getColumnNameAndConfig(a, b);
  if (config.mode === "json") {
...
__publicField(_SelectionProxyHandler, _Wa, "SelectionProxyHandler");
...
class SQLiteTable extends (_$a = Table, __a = entityKind, _Za = Table.Symbol.Columns, _Ya = InlineForeignKeys, _Xa = Table.Symbol.ExtraConfigBuilder, _$a) {
  constructor() {
    super(...arguments);
    /** @internal */
    __publicField(this, _Za);
    /** @internal */
    __publicField(this, _Ya, []);
    /** @internal */
    __publicField(this, _Xa);
  }
}
__publicField(SQLiteTable, __a, "SQLiteTable");
/** @internal */
...
class SQLiteDeleteBase extends (_bb = QueryPromise, _ab = entityKind, _bb) {
...
__publicField(SQLiteDeleteBase, _ab, "SQLiteDelete");
...
__publicField(CasingCache, _cb, "CasingCache");
class SQLiteViewBase extends (_eb = View, _db = entityKind, _eb) {
}
__publicField(SQLiteViewBase, _db, "SQLiteViewBase");
_fb = entityKind;
class SQLiteDialect {
  constructor(config) {
    /** @internal */
...
__publicField(SQLiteDialect, _fb, "SQLiteDialect");
class SQLiteSyncDialect extends (_hb = SQLiteDialect, _gb = entityKind, _hb) {
...
__publicField(SQLiteSyncDialect, _gb, "SQLiteSyncDialect");
_ib = entityKind;
...
__publicField(TypedQueryBuilder, _ib, "TypedQueryBuilder");
_jb = entityKind;
...
__publicField(SQLiteSelectBuilder, _jb, "SQLiteSelectBuilder");
class SQLiteSelectQueryBuilderBase extends (_lb = TypedQueryBuilder, _kb = entityKind, _lb) {
...
__publicField(SQLiteSelectQueryBuilderBase, _kb, "SQLiteSelectQueryBuilder");
class SQLiteSelectBase extends (_nb = SQLiteSelectQueryBuilderBase, _mb = entityKind, _nb) {
  constructor() {
    super(...arguments);
    __publicField(this, "run", (placeholderValues) => {
      return this._prepare().run(placeholderValues);
...
__publicField(SQLiteSelectBase, _mb, "SQLiteSelect");
...
__publicField(QueryBuilder, _ob, "SQLiteQueryBuilder");
_pb = entityKind;
...
__publicField(SQLiteInsertBuilder, _pb, "SQLiteInsertBuilder");
class SQLiteInsertBase extends (_rb = QueryPromise, _qb = entityKind, _rb) {
...
__publicField(SQLiteInsertBase, _qb, "SQLiteInsert");
_sb = entityKind;
...
__publicField(SQLiteUpdateBuilder, _sb, "SQLiteUpdateBuilder");
class SQLiteUpdateBase extends (_ub = QueryPromise, _tb = entityKind, _ub) {
...
__publicField(SQLiteUpdateBase, _tb, "SQLiteUpdate");
const _SQLiteCountBuilder = class _SQLiteCountBuilder extends (_xb = SQL, _wb = entityKind, _vb = Symbol.toStringTag, _xb) {
  constructor(params) {
    super(_SQLiteCountBuilder.buildEmbeddedCount(params.source, params.filters).queryChunks);
    __publicField(this, "sql");
    __publicField(this, _vb, "SQLiteCountBuilderAsync");
    __publicField(this, "session");
    this.params = params;
...
__publicField(_SQLiteCountBuilder, _wb, "SQLiteCountBuilderAsync");
...
__publicField(RelationalQueryBuilder, _yb, "SQLiteAsyncRelationalQueryBuilder");
class SQLiteRelationalQuery extends (_Ab = QueryPromise, _zb = entityKind, _Ab) {
...
__publicField(SQLiteRelationalQuery, _zb, "SQLiteAsyncRelationalQuery");
class SQLiteSyncRelationalQuery extends (_Cb = SQLiteRelationalQuery, _Bb = entityKind, _Cb) {
  sync() {
    return this.executeRaw();
  }
}
__publicField(SQLiteSyncRelationalQuery, _Bb, "SQLiteSyncRelationalQuery");
class SQLiteRaw extends (_Eb = QueryPromise, _Db = entityKind, _Eb) {
...
__publicField(SQLiteRaw, _Db, "SQLiteRaw");
_Fb = entityKind;
...
__publicField(BaseSQLiteDatabase, _Fb, "BaseSQLiteDatabase");
_Gb = entityKind;
...
__publicField(IndexBuilderOn, _Gb, "SQLiteIndexBuilderOn");
_Hb = entityKind;
class IndexBuilder {
...
__publicField(IndexBuilder, _Hb, "SQLiteIndexBuilder");
_Ib = entityKind;
class Index {
...
__publicField(Index, _Ib, "SQLiteIndex");
function index(name) {
  return new IndexBuilderOn(name, false);
}
class ExecuteResultSync extends (_Kb = QueryPromise, _Jb = entityKind, _Kb) {
...
__publicField(ExecuteResultSync, _Jb, "ExecuteResultSync");
_Lb = entityKind;
...
__publicField(SQLitePreparedQuery, _Lb, "PreparedQuery");
_Mb = entityKind;
class SQLiteSession {
  constructor(dialect) {
    this.dialect = dialect;
...
__publicField(SQLiteSession, _Mb, "SQLiteSession");
class SQLiteTransaction extends (_Ob = BaseSQLiteDatabase, _Nb = entityKind, _Ob) {
...
__publicField(SQLiteTransaction, _Nb, "SQLiteTransaction");
const trackItems = sqliteTable(
  "TrackItems",
  {
...
class BetterSQLiteSession extends (_Qb = SQLiteSession, _Pb = entityKind, _Qb) {
...
__publicField(BetterSQLiteSession, _Pb, "BetterSQLiteSession");
const _BetterSQLiteTransaction = class _BetterSQLiteTransaction extends (_Sb = SQLiteTransaction, _Rb = entityKind, _Sb) {
...
__publicField(_BetterSQLiteTransaction, _Rb, "BetterSQLiteTransaction");
let BetterSQLiteTransaction = _BetterSQLiteTransaction;
class PreparedQuery extends (_Ub = SQLitePreparedQuery, _Tb = entityKind, _Ub) {
...
__publicField(PreparedQuery, _Tb, "BetterSQLitePreparedQuery");
class BetterSQLite3Database extends (_Wb = BaseSQLiteDatabase, _Vb = entityKind, _Wb) {
}
__publicField(BetterSQLite3Database, _Vb, "BetterSQLite3Database");
...
sqlite.pragma("mmap_size = 1000000000");
sqlite.pragma("page_size = 8192");
sqlite.pragma("auto_vacuum = INCREMENTAL");
sqlite.pragma("busy_timeout = 5000");
const db = drizzle(sqlite, { schema });
const logger$3 = console;
async function insertDefaultData(db2) {
  logger$3.debug("Checking for default data");
  const onlineSetting = await db2.select().from(appSettings).where(eq(appSettings.name, "ONLINE")).get();
  if (!onlineSetting) {
    logger$3.debug("Inserting ONLINE default setting");
    await db2.insert(appSettings).values({ name: "ONLINE", color: "#7ed321" });
  }
  const offlineSetting = await db2.select().from(appSettings).where(eq(appSettings.name, "OFFLINE")).get();
  if (!offlineSetting) {
    logger$3.debug("Inserting OFFLINE default setting");
    await db2.insert(appSettings).values({ name: "OFFLINE", color: "#f31b1b" });
  }
  const idleSetting = await db2.select().from(appSettings).where(eq(appSettings.name, "IDLE")).get();
  if (!idleSetting) {
    logger$3.debug("Inserting IDLE default setting");
    await db2.insert(appSettings).values({ name: "IDLE", color: "#f5a623" });
  }
  logger$3.debug("Default data check complete");
}
function checkForKnexMigrationTables(sqlite2) {
  logger$3.debug("Checking for knex migration tables");
  try {
    const knexMigrationsExist = sqlite2.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='knex_migrations'").get();
    const knexMigrationsLockExist = sqlite2.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='knex_migrations_lock'").get();
    const tablesExist = !!knexMigrationsExist && !!knexMigrationsLockExist;
    logger$3.debug(`Knex migration tables exist: ${tablesExist}`);
    return tablesExist;
  } catch (error) {
    logger$3.error("Error checking for knex migration tables:", error);
    return false;
  }
}
function checkIfAppTablesExist(sqlite2) {
  logger$3.debug("Checking if application tables already exist");
  try {
    const trackItemsExist = sqlite2.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='TrackItems'").get();
    const appSettingsExist = sqlite2.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='AppSettings'").get();
    const settingsExist = sqlite2.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='Settings'").get();
    const tablesExist = !!trackItemsExist && !!appSettingsExist && !!settingsExist;
    logger$3.debug(`Application tables exist: ${tablesExist}`);
    return tablesExist;
  } catch (error) {
    logger$3.error("Error checking for application tables:", error);
    return false;
  }
}
function removeKnexMigrationTables(sqlite2) {
  logger$3.debug("Removing knex migration tables");
  try {
    sqlite2.prepare("DROP TABLE IF EXISTS knex_migrations").run();
    sqlite2.prepare("DROP TABLE IF EXISTS knex_migrations_lock").run();
    logger$3.debug("Knex migration tables removed successfully");
  } catch (error) {
    logger$3.error("Error removing knex migration tables:", error);
  }
}
async function connectAndSync(sqlite2, db2) {
  try {
    ...
    if (!fs$1.existsSync(metaDir)) {
      ...
      fs$1.mkdirSync(metaDir, { recursive: true });
    }
    ...
    if (hasKnexTables && hasAppTables) {
      ...
      const initialMigrationFiles = fs2.readdirSync(migrationsFolder).filter((file) => file.endsWith(".sql")).sort();
      const initialMigrationFile = initialMigrationFiles.find((file) => file.startsWith("0000_"));
      if (initialMigrationFile) {
        const migrationTag = initialMigrationFile.replace(".sql", "");
        const existingMigration = sqlite2.prepare("SELECT * FROM drizzle_migrations WHERE hash = ?").get(migrationTag);
        if (!existingMigration) {
          sqlite2.prepare("INSERT INTO drizzle_migrations (hash, created_at) VALUES (?, ?)").run(migrationTag, Date.now());
          logger$3.debug(`Marked initial migration "${migrationTag}" as applied`);
        }
      }
    ...
    logger$3.error("Error connecting to database or applying migrations:", error);
    throw error;
  }
}
const initDb = async () => {
...
const cache$1 = {};
async function createAppSetting(appSettingAttributes) {
  const [appSetting] = await db.insert(appSettings).values(appSettingAttributes).returning() || [null];
  const { name } = appSettingAttributes;
  if (name) {
    cache$1[name] = appSetting || null;
  }
  logger$2.debug(`Created appSetting with title ${appSettingAttributes.name}.`);
  return appSetting;
}
async function retrieveAppSettings(name) {
  if (cache$1[name]) {
    return cache$1[name];
  }
  const results = await db.select().from(appSettings).where(eq(appSettings.name, name));
  const item = results.length > 0 ? results[0] : null;
  cache$1[name] = item || null;
  logger$2.debug("Retrieved appSetting:", name);
  return item || null;
}
async function getAppColor(appName) {
  console.warn("getAppColor", appName);
  const appSetting = await retrieveAppSettings(appName);
  if (appSetting == null ? void 0 : appSetting.color) {
    console.warn("getAppColor:::", appSetting.color);
    return appSetting.color;
  } else {
    const color = randomcolor();
    console.warn("getAppColor randomcolor", color);
    const item = await createAppSetting({ name: appName, color });
    logger$2.debug("Created color item to DB:", item);
    return color;
  }
}
async function changeColorForApp(appName, color) {
  logger$2.debug("Changing color with params:", appName, color);
  const appSetting = await retrieveAppSettings(appName);
  if (appSetting) {
    const [updated] = await db.update(appSettings).set({ color }).where(eq(appSettings.id, appSetting.id)).returning();
    if (updated) {
      cache$1[appName] = updated;
    }
    logger$2.debug("Saved color item to DB:", updated);
    return updated;
  } else {
    const item = await createAppSetting({ name: appName, color });
    logger$2.debug("Created color item to DB:", item);
...
const cache = {};
async function findCreateFind(name) {
...
async function updateByName(name, jsonDataStr) {
  logger$1.debug("Updating Setting:", name, jsonDataStr);
  try {
    const jsonData = JSON.parse(jsonDataStr);
    let item = await findByName(name);
    if (item) {
      const [updated] = await db.update(settings).set({ jsonData: JSON.stringify(jsonData) }).where(eq(settings.id, item.id)).returning() || [null];
      delete cache[name];
      if (name === "WORK_SETTINGS") {
        ...
        if (workSettings.smallNotificationsEnabled !== jsonData.smallNotificationsEnabled) {
          logger$1.debug("Emitting smallNotificationsEnabled-changed", jsonData.smallNotificationsEnabled);
        }
      }
      return updated;
    } else {
      logger$1.error(`No item with ${name} found to update.`);
      return null;
    }
  } catch (e) {
    logger$1.error("Parsing jsonData failed:", e, jsonDataStr);
    return null;
  }
}
function parseWorkSettings(jsonData) {
  try {
    return JSON.parse(jsonData);
  } catch (e) {
    logger$1.error("Error parsing work settings:", e);
...
async function fetchDataSettings() {
  ...
  try {
    ...
    logger$1.error("Error parsing data settings:", e);
    return defaultSettings;
  }
}
...
async function fetchAnalyserSettings() {
  ...
  try {
    ...
    logger$1.error("Error parsing analyser settings:", e);
    return [];
  }
}
...
async function getAnalyserEnabled() {
  ...
  try {
    ...
    logger$1.error("Error parsing ANALYSER_ENABLED setting:", e);
    return false;
  }
}
async function setAnalyserEnabled(enabled) {
...
async function getRunningLogItemAsJson() {
  ...
  try {
    ...
    if (!newTrackItem.app) {
      logger$1.debug("No app in RUNNING_LOG_ITEM.  Invalid item:", newTrackItem);
      return null;
    }
    ...
    logger$1.debug("Running log item:", newTrackItem);
    return newTrackItem;
  } catch (e) {
    logger$1.error("Error parsing RUNNING_LOG_ITEM:", e);
    return null;
  }
}
async function saveRunningLogItemReference(newTrackItem) {
  if (!newTrackItem) {
    logger$1.debug("Clearing running log item");
    await updateByName(RUNNING_LOG_ITEM, "{}");
    return null;
  }
  logger$1.debug("Creating running log item: ", newTrackItem);
...
async function createTrackItem(trackItemAttributes) {
  const result = await db.insert(trackItems).values(trackItemAttributes).returning();
  return result[0];
}
async function updateTrackItemDb(itemData, id) {
  logger.debug("Updating track item:", id, itemData);
  const result = await db.update(trackItems).set({
    app: itemData.app,
  ...
  }).where(eq(trackItems.id, id)).returning();
  return result.length;
}
async function findItemsForExport(from, to, taskName, searchStr) {
  const conditions = [
  ...
  const results = await db.select().from(trackItems).where(and(...conditions));
  return results;
}
async function findAllItems(from, to, taskName, searchStr, paging, sumTotal) {
  var _a2, _b2;
  const conditions = [
    eq(trackItems.taskName, taskName),
    gte(trackItems.endDate, new Date(from).getTime()),
  ...
  const order = orderByKey[paging.sortByKey] || trackItems.endDate;
  const orderByFn = paging.sortByOrder === "desc" ? desc : asc;
  let query = db.select().from(trackItems).where(and(...conditions)).orderBy(orderByFn(order));
  const data = await query.limit(paging.limit || DEFAULT_PAGE_SIZE).offset(paging.offset || 0);
  const countResult = await db.select({ count: sql`COUNT(*)` }).from(trackItems).where(and(...conditions));
  const totalCount = parseInt((_a2 = countResult[0]) == null ? void 0 : _a2.count) || 0;
  if (sumTotal) {
    const totalResult = await db.select({
      totalMs: sql`SUM(${trackItems.endDate}/1000 - ${trackItems.beginDate}/1000)`
    }).from(trackItems).where(and(...conditions)).orderBy(orderByFn(order));
    const totalDuration = ((_b2 = totalResult[0]) == null ? void 0 : _b2.totalMs) || 0;
    return {
      data,
      total: totalCount,
      totalDuration: parseInt(totalDuration) * 1e3
      // Convert seconds to milliseconds
    };
  }
  return { data, total: totalCount };
}
async function findAllDayItemsDb(from, to, taskName) {
  console.log("findAllDayItems", from, to, taskName);
  const data = await db.select().from(trackItems).where(
    and(
      eq(trackItems.taskName, taskName),
      gte(trackItems.endDate, new Date(from).getTime()),
      lte(trackItems.endDate, new Date(to).getTime())
...
async function findFirstChunkLogItemsDb() {
  ...
  }).from(trackItems).where(eq(trackItems.taskName, TrackItemType.LogTrackItem)).groupBy(trackItems.app, trackItems.title).orderBy(desc(trackItems.endDate)).limit(10);
  return items;
}
async function findFirstTrackItem() {
  return await db.select().from(trackItems).where(eq(trackItems.taskName, TrackItemType.AppTrackItem)).orderBy(trackItems.beginDate).limit(1);
}
async function findLastOnlineItem() {
  const appName = State.Online;
  const results = await db.select().from(trackItems).where(and(eq(trackItems.app, appName), eq(trackItems.taskName, TrackItemType.StatusTrackItem))).orderBy(desc(trackItems.endDate)).limit(1);
  return results[0];
}
async function updateTrackItemColor(appName, color) {
...
async function findAllFromLastHoursDb(hours) {
  const now2 = DateTime.now();
  const items = await db.select().from(trackItems).where(
    and(
      eq(trackItems.app, State.Online),
      eq(trackItems.taskName, TrackItemType.StatusTrackItem),
      gte(trackItems.endDate, now2.minus({ hours }).toMillis())
    )
  ).orderBy(asc(trackItems.beginDate));
  return items;
}
...
function createTrackItemWithDates(originalItem, beginDate, endDate) {
  return {
    ...originalItem,
    beginDate,
    endDate
...
function splitTrackItemAtMidnight(item) {
...
async function saveSplitItems(splitItems, originalItem) {
...
async function updateTrackItemInternal(id, appName, item) {
...
async function insertTrackItemInternal(item) {
...
async function insertNewLogTrackItem(item) {
